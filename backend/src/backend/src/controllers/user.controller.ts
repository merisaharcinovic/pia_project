...
export class UserController{
  ...
  requestCollaboration = (req: express.Request, res: express.Response) => {
    const agencyId = req.body.agency // Pretpostavljamo da dobijate agencyId iz URL parametra
    ...
    User.findById(agencyId, (err, agency) => {
      ...
      agency.agency.requests.push(request);
      ...
      agency.save((err) => {
        ...
        res.json({ message: 'Uspesno poslat zahtev za saranju.' });
      });
    });
  }
}